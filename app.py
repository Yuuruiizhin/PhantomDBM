...
# Modificamos la inicialización de Flask para usar rutas relativas.
# Se crea la instancia de la aplicación Flask y se le pasa la ruta del directorio
# donde se encuentran las plantillas y los archivos estáticos.
app = Flask(__name__,
